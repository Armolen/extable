...
use ciscmodule\modoee\Interfaces\moduleInterface;

class oeeprzedmont implements moduleInterface
{
	/**
	 * @var Admin
	 */
	...
	public function template()
	{
		...
		{
			$templateClass = config('modoee.template');
...
//		return new MenuItem($model);
	...
	{
		$controller = app('ciscmodule\oeeprzedmont\Http\Controllers\OeeController');
